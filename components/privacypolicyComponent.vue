<template>
  <div>
    <article>
    <h1>プライバシーポリシー</h1>
    <p><span id="company">konoderapombe</span>（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
    ...
    社名： <span id="company2">konoderapombe</span><br>
