    ...
    <div id="wrap" class="parallax_box">
      <div id="wrapChild" class="parallax_content img_bg_01">
        ...
        <div class="box fade-in">
          <a
            href="https://github.com/U3cSeroH1"
            class="myNameIcon poyopoyo"
          ></a>
        </div>
        ...
        <div class="gridcontainer">
          <div class="grid">
            <img
              class="gridimg"
              src="~/static/create/01ESZ37QD6WQ00JQBME08GW3A3.png"
            />
          </div>
          <div class="grid">
            <div class="text">
          ...
          <div class="grid">
            <img
              class="gridimg"
              src="~/static/create/01F8KQAT4A62VX7NGXE7HAM1D5.jpeg"
            />
          </div>
          <div class="grid">
            <div class="pic">
              ...
              <img
                class="gridimg"
                src="~/static/create/12d65f32ac17e7b163df71bac9da596f.jpg"
              />
              <p>creating world</p>
            </div>
          </div>
          <div class="grid">
            <img
              class="gridimg"
              src="~/static/create/9f52c275e48e26617d81995c5ddff47c.png"
            />
          </div>
          <div class="grid">
            <img
              class="gridimg"
              src="~/static/create/ccae212702f96708d94dc89aa6ef9638.png"
            />
          </div>
          <div class="grid">
            <img
              class="gridimg"
              src="~/static/create/a6451e7aac0469ec1e7ca15ab24bfbc6.jpg"
            />
          </div>
          <div class="grid">
            <div class="text">
          ...
          <div class="grid">
            <img
              class="gridimg"
              src="~/static/create/aef9df6652ee2b16c3f123d36fe3d284.png"
            />
          </div>
          <div class="grid">
            <img
              class="gridimg"
              src="~/static/create/c07a79759cb901350fd9428e386f26b1.jpg"
            />
          </div>
          <div class="grid">
            <img
              class="gridimg"
              src="~/static/create/ce0c91ba9ba27af8f4181473bb16bcd0.png"
            />
          </div>
          <div class="grid">
            <div class="pic">
              ...
              <img
                class="gridimg"
                src="~/static/create/e20706bde0bcba86eb6c42af262af93a.png"
              />
              <p>inventory</p>
            </div>
          </div>
          <div class="grid">
            <div class="text">
              <h2>Game & Web</h2>
              <p>
                sugoi kakkoii eigo mitaini mieru bunsyou. eigo wakannaine.
                dakaratekitounikaiteiruyo. yappari eigo kakaretetara
                kakkoiizyan? souomotte kaitandayo korewo yondeiru anataha
                surudoi. mettya sugoi. yotabanasi dakedo kono po-toforio saitoha
                daitai nisyuukande tukuttayo nidoto typescript tukaitaku nainaa
                tte omotta. tehepero.
              </p>
            </div>
          </div>
          <div class="grid">
            <div class="pic">
              ...
              <img
                class="gridimg"
                src="~/static/create/f533eb347997fe40d11741d06f9fd76c.png"
              />
              <p>adding keyflame</p>
            </div>
          </div>
          <div class="grid">
            <img
              class="gridimg"
              src="~/static/create/fb8404eae7b0b2ef616ed8637a13588b.png"
            />
          </div>
        </div>
      </div>
      ...
      <div id="wrapChild" class="parallax_content img_bg_04">
        ...
        <div class="commentSpace">
          <div class="normalcontext">
            VRChat World
            <div class="normalcontextsmall">MY FRENDS HOUSE IN VR</div>
          </div>
        </div>
        <div class="btnBox">
          <a
...
export default Vue.extend({
  ...
  methods: {
    ...
    wheelFlagFalse() {
      //0.8秒後にwheelFlagをfalseにして次のページめくれるように
